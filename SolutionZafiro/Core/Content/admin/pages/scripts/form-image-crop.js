var FormImageCrop = function () {
    ...
    var demo4 = function() {
        ...
        Backbones.updateUniform('#fadetog');
    ...
    var demo5 = function() {
        ...
        function initJcrop()//{{{
        {
          ...
          $('#demo5').Jcrop({
            ...
            Backbones.updateUniform('#can_click,#can_move,#can_size');

            $('#ar_lock,#size_lock,#bg_swap').attr('checked',false);
            Backbones.updateUniform('#ar_lock,#size_lock,#bg_swap');
        ...
        function releaseCheck()
        {
          ...
          Backbones.updateUniform('#can_click');
        };
    ...
    return {
        ...
        init: function () {
            ...
            Backbones.addResizeHandler(handleResponsive);
            handleResponsive();
