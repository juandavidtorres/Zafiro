var ChartsAmcharts = function() {
    ...
    var initChartSample1 = function() {
        var chart = AmCharts.makeChart("chart_1", {
            ...
            "exportConfig": {
                ...
                "menuRight": "22px",
                "menuItems": [{
                    "icon": Backbones.getGlobalPluginsPath() + "amcharts/amcharts/images/export.png",
                    "format": 'png'
                }]
            }
        });
    ...
    var initChartSample2 = function() {
        var chart = AmCharts.makeChart("chart_2", {
            ...
            "pathToImages": Backbones.getGlobalPluginsPath() + "amcharts/amcharts/images/",
    ...
    var initChartSample8 = function() {
        ...
        */
        ...
        AmCharts.ready(function() {
            ...
            map.pathToImages = Backbones.getGlobalPluginsPath() + "amcharts/ammap/images/",
    ...
    var initChartSample9 = function() {
        ...
        var map = AmCharts.makeChart("chart_9", {
            type: "map",
            "theme": "light",
            pathToImages: Backbones.getGlobalPluginsPath() + "amcharts/ammap/images/",
