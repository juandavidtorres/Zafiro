...
var Demo = function () {
    ...
    var handleTheme = function () {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(Backbones.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function (color) {
            var color_ = (Backbones.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (Backbones.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", Backbones.getGlobalCssPath() + file + ".css");
