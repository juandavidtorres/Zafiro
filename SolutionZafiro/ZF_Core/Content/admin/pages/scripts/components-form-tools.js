var ComponentsFormTools = function () {
    ...
    var handleTwitterTypeahead = function() {
        ...
        $('#typeahead_example_1').typeahead(null, {
          displayKey: 'num',
          hint: (Backbones.isRTL() ? false : true),
    ...
    var handleBootstrapMaxlength = function() {
        ...
        $('#maxlength_placement').maxlength({
            limitReachedClass: "label label-danger",
            alwaysShow: true,
            placement: Backbones.isRTL() ? 'top-right' : 'top-left'
        });
    }
    ...
    var handleUsernameAvailabilityChecker1 = function () {
        ...
        $("#username1_checker").click(function (e) {
            ...
            if (input.val() === "") {
                ...
                pop.popover('destroy');
                pop.popover({
                    'placement': (Backbones.isRTL() ? 'left' : 'right'),
                    'html': true,
                    'container': 'body',
                ...
                // set last poped popover to be closed on click(see Backbones.js => handlePopovers function)     
                Backbones.setLastPopedPopover(pop);
                pop.popover('show');
        ...
        $("#username2_input").change(function () {
            ...
            $.post('demo/username_checker.php', {
                ...
                if (res.status == 'OK') {
                    ...
                    Backbones.setLastPopedPopover(input);
                }
