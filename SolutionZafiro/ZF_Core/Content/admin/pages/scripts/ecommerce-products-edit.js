var EcommerceProductsEdit = function () {
            ...
            init: {
                ...
                FileUploaded: function(up, file, response) {
                    ...
                    if (response.result && response.result == 'OK') {
                        ...
                        Backbones.alert({type: 'danger', message: 'One of uploads failed. Please retry.', closeInSeconds: 10, icon: 'warning'});
                    }
                },
         
                Error: function(up, err) {
                    Backbones.alert({type: 'danger', message: err.message, closeInSeconds: 10, icon: 'warning'});
                }
            }
        });
    ...
    var initComponents = function () {
        ...
        $(".datetime-picker").datetimepicker({
            isRTL: Backbones.isRTL(),
            autoclose: true,
            todayBtn: true,
            pickerPosition: (Backbones.isRTL() ? "bottom-right" : "bottom-left"),
            minuteStep: 10
        });
